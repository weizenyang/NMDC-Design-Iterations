...
// Modified version for Riyadh City AR that only renders a white wireframe

Shader "RiyadhCityAR/SpatialMapping/Wireframe"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (g2f i) : SV_Target
            {
                ...
                // Riyadh City AR edit - only use white lines
                /*
                ...
                */
                fixed4 wireColor = fixed4(1.0, 1.0, 1.0, 1.0);
